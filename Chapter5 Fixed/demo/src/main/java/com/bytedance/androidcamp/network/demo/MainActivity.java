...
public class MainActivity extends AppCompatActivity {
    ...
    public void testHttpURLConnectionSync(View view) {
        ...
        class URLAsynkTask extends AsyncTask<Object,String,String>{
            @Override
    ...
    public void testRetrofitSync(View view) {
        ...
        class RetrofitSyns extends AsyncTask<Object,Integer,String>{
            @Override
            protected String doInBackground(Object... objects) {
...
//                try {
//                    response = service.call().execute();
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
//                Cat cat = response == null ? null : (Cat) response.body();
//                return cat;
            }
